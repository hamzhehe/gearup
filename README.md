...
2. **Settings → Build & Deployment** (reset all overrides):
   - **Root Directory:** leave **empty** (root `vercel.json` builds `frontend-next`)
   - **Framework Preset:** Next.js
   - **Output Directory:** leave **empty** — delete `public` if set (causes 404)
