                ...
                <div>
                  ...
                  {business.businessLicense ? (
                    <div className="mt-2 space-y-3">
                      <div className="inline-flex items-center gap-2 rounded-[12px] border border-[#E5E7EB] bg-[#F8FAFC] px-3 py-2">
                      ...
                      <button
                        ...
                        onClick={async () => {
                          try {
                            await openSecureVerificationDocument(user._id);
                          } catch (error) {
                            console.error('Failed to open verification document', error);
                          }
                        }}
                      ...
                      >
                        <FileText size={16} className="text-[#00B894]" />
