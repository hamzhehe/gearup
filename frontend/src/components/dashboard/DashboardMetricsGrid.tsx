...
export default function DashboardMetricsGrid({
    ...
    const sectionTitle = isManufacturer ? "Manufacturer Overview" : "Procurement Overview";
    ...
    const ordersLabel = isManufacturer ? "Sales Orders" : "Purchase Orders";
    const ordersCount = isManufacturer ? (data.salesOrdersCount || 0) : (data.purchaseOrdersCount || 0);

    const cards = [
        // Card 1: PURCHASE ORDERS / SALES ORDERS (Primary)
        {
            label: ordersLabel,
            value: ordersCount,
        ...
        // Card 2: MANUFACTURER ONLY: Purchase Orders
        ...(isManufacturer ? [{
            label: 'Purchase Orders',
            value: data.purchaseOrdersCount || 0,
            change: `Procurement`,
            trend: 'neutral',
            icon: ShoppingCart,
            color: 'text-blue-600 bg-blue-50 border-blue-100/60',
            href: '/manufacturer/purchases'
        }] : []),
